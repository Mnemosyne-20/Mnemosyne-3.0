...
<http://archive.is/timemap/http://kernel.org/>; rel=""self""; type=""application/link-format""; from=""Wed, 23 May 2012 21:04:12 GMT""; until=""Wed, 08 Mar 2017 19:19:42 GMT""";
        ...
        {
            Mementos mementos = new Mementos(ParseWebLinks.Parse(Test));
        ...
        {
            var link = ParseWebLinks.Parse(Test).Where(a => a.Parameters["rel"].Contains("self")).First();
        ...
        {
            var links = ParseWebLinks.Parse(Test);
            var link = ParseWebLinks.Parse(Test).Where(a => a.Parameters["rel"].Contains("self")).Last();
